local constantMap = require "constantMap"
...
function template.render(view, context, key, plain)
    ...
    context['resources'] = param.getResources()
    context['cdn'] = param.getImgResources()
    context['version'] = param.getVersion()
    context['basePath'] = param.getBasePath()
    context = constantMap.getParams(context)
