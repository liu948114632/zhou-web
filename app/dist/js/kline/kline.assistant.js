...
Kline.prototype = {
    ...
    setFirstRecord: function (e) {
        ...
        // console.log(a);
        // var b = DOMAIN_TRANS + "/api/v2/market/depth?symbol=" + a + "&lastTime=0&length=10&depth=0";
        ...
        //             d.tradeDate.setTime(o[k].date * 1000);
        ...
        //                 n = "<span>/ ￥" + d.fixNumber(btctocny * d.curPrice, 2) + "</span>"
        //             } else {
        //                 if (d.symbol.endsWith("usdt") && usdttocny) {
        //                     n = "<span>/ ￥" + d.fixNumber(usdttocny * d.curPrice, 2) + "</span>"
        //                 }
        //             }
        //         } catch (m) {
        //         }
        //         $("div#price").attr("class", o[o.length - 1].type == "buy" ? "green" : "red").html(d.curPrice + (n ? n : ""));
...
function getMarket(b) {
    // var a = this;
    // $.getJSON(DOMAIN_TRANS + "/line/topall?jsoncallback=?", function (c) {
    //     window.usdttocny = c.usdtcny;
    //     window.btctocny = c.datas[0].lastPrice * c.usdtcny
    // })
}
...
var hashMap = function () {
    ...
    this.entrys = function () {
        ...
        var c = new Array(a);
        for (var b = 0; b < a; b++) {
            c[b] = {key: this.keys[b], value: this.data[b]}
        }
        return c
    }
};