 ...
 (function($){
	...
	$.extend($.PaginationRenderers.defaultRenderer.prototype, {
		...
		getLinks:function(current_page, eventHandler,psize) {
			...
			if(!isEmpty(psize))np = Math.ceil(this.maxentries / psize);
			...
			if(this.opts.showGo)fragment.append("<a href='javascript:void(0);'  style='float:left;'>Total amount:<label class='tmui_page_itemcount'>"+this.maxentries+"</label></a>&nbsp;<a href='javascript:void(0);' title='' style='' class='tm_go'>GO</a><input type='text' title='' class='tm_number' value='"+proxySzie+"' id='tm_pagego'/>");
			return fragment;
	...
	$.fn.pagination = function(maxentries, opts){
		...
		function selectPage(new_current_page) {
			...
			links.appendTo(containers);
			 $(".tm_number").attr("title", " Number please...").on("keydown",
			    function(e) {
