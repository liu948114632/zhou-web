...
app.controller('modLoginCtrl',['$scope', '$http',function($scope, $http){
    ...
    $scope.mod = function () {
        ...
        $http.post("/api/v1/account/modPassWord",$.param(data),{headers :{'Content-Type' :'application/x-www-form-urlencoded' }})
            .then(function (res) {
